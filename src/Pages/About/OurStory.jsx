  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-gray-100 mb-8 text-center">
          Our <span className="text-sky-600 dark:text-sky-400">Story</span>
        </h2>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="bg-sky-100 dark:bg-sky-900 p-6 rounded-xl border border-sky-200 dark:border-sky-700">
            <h3 className="text-xl font-bold text-sky-800 dark:text-sky-300 mb-3">
              Did You Know?
            </h3>
