...
const FAQSection = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-white to-[#f1f6fa] py-16 px-4 sm:px-6 lg:px-8">
        ...
        {faqs.map((faq, index) => (
          ...
          >
            <button
              ...
              className="w-full px-6 py-5 flex items-center justify-between text-left text-gray-800 font-medium text-lg"
            >
              {faq.question}
              {openIndex === index ? (
